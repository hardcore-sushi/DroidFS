    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!storageAvailable) {
            ColoredAlertDialog(this)
                    ...
                    .setMessage(getString(R.string.storage_unavailable_msg, getString(R.string.app_name)))
        ...
        image_logo.viewTreeObserver.addOnPreDrawListener(object : ViewTreeObserver.OnPreDrawListener {
            override fun onPreDraw(): Boolean {
                image_logo.viewTreeObserver.removeOnPreDrawListener(this)
                image_logo.requestLayout()
                image_logo.layoutParams.height = image_logo.measuredWidth
                return true
            }
        })
    }
            ...
            STORAGE_PERMISSIONS_REQUEST -> if (grantResults.size == 2) {
                if (grantResults[0] != PackageManager.PERMISSION_GRANTED || grantResults[1] != PackageManager.PERMISSION_GRANTED) {
                    ColoredAlertDialog(this)
                            ...
                            .setMessage(getString(R.string.storage_perm_denied_msg, getString(R.string.app_name)))
                            .setPositiveButton(R.string.ok
                            ) { _, _ -> finish() }.show()
                }
            }
