 ...
 */
class SucklessPendingRecording
internal constructor(
    context: Context,
    private val recorder: SucklessRecorder,
    ...
    @JvmName("getRecorder") internal fun getRecorder(): SucklessRecorder = recorder
    ...
    @JvmOverloads
    public fun withAudioEnabled(initialMuted: Boolean = false): SucklessPendingRecording {
    ...
    public fun asPersistentRecording(): SucklessPendingRecording {
        isPersistent = true
        return this
    }
     ...
     */
    @CheckResult
    public fun start(listenerExecutor: Executor, listener: Consumer<VideoRecordEvent>): SucklessRecording {
    ...
    public suspend fun start(listener: Consumer<VideoRecordEvent>): SucklessRecording {
